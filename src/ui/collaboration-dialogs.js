...
export function collaboratorManagementDialog(entityType, entityId) {
  ...
  return `<div id="collab-mgmt-dialog" class="dialog-overlay" style="display:none" data-dialog-close="collab-mgmt-dialog" role="dialog" aria-modal="true" aria-labelledby="collab-mgmt-dialog-title" aria-hidden="true">
